...
const server = app.listen(app.get('port'), () => {
    console.log(`⚡️[coda-dashboard-api]: Server is running at http://localhost:${port}`);
    console.log(`⚡️[coda-dashboard-api]: Running ${version.getBuildVersion()} version of build`);
});
